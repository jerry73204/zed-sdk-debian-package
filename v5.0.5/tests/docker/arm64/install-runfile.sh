#!/bin/bash
# ZED SDK ARM64 Official Runfile Installation Script
...
# URLs for official downloads (ARM64 uses same files as AMD64 for the main SDK)
ZED_RUN_URL="https://download.stereolabs.com/zedsdk/5.0/cu12/ubuntu22"
PYZED_WHEEL_URL="https://download.stereolabs.com/zedsdk/5.0/whl/linux_aarch64/pyzed-5.0-cp310-cp310-linux_aarch64.whl"

# File names
ZED_RUN_FILE="ZED_SDK_Ubuntu22_cuda12.8_tensorrt10.9_v${ZED_VERSION}.zstd.run"
PYZED_WHEEL_FILE="pyzed-5.0-cp310-cp310-linux_aarch64.whl"

echo "=========================================="
echo "ZED SDK ARM64 Official Installation"
echo "=========================================="
...
# Download Python wheel (ARM64 specific)
echo "Downloading Python wheel for ARM64..."
...
# Install Python wheel (ARM64 specific)
echo "Installing Python wheel for ARM64..."
cd "$WORK_DIR"
...
echo "=========================================="
echo "ZED SDK ARM64 installation completed!"
echo "=========================================="
